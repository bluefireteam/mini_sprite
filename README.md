...
The flutter application, deployed at [https://minisprit.es](https://minisprit.es), which can be
used to design sprites and maps using the Mini Sprite format.
...
Join the Bluefire [discord server](https://discord.gg/pxrBmy4) to ask questions to the team and the
community.
...
- [ ] Improve Map editor performance. One of the feedbacks received during the Game Jam, the map
...
- [ ] Improve shortcuts support. Mini Sprite Editor already have some shortcuts, but they are very
 ...
 a good solution for it before the editor grows more in features.
